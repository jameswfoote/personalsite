...
export default function Bookshelf() {
  ...
  const books = [
    ...
    { title: "How to Be Free", author: "Epictetus", cover: "https://pictures.abebooks.com/isbn/9780691177717-us.jpg", review: "Epictetus's Stoic guide to inner freedom. Drawing on the Encheiridion and Discourses, it argues that freedom comes from governing our judgments and desires while accepting what lies outside our control." },
    ...
    { title: "I See Satan Fall Like Lightning", author: "René Girard", cover: "https://pictures.abebooks.com/isbn/9781570753190-us.jpg", review: "Girard's profound exploration of mimetic theory and scapegoating mechanisms. A revolutionary understanding of violence, religion, and the foundations of human culture." },
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Main Content */}
      <main style={{ maxWidth: '1200px', margin: '0 auto', padding: '60px 30px 20px' }}>
