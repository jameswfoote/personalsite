  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <header style={{ padding: '20px 0', borderBottom: '1px solid #e5e5e5' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 30px', textAlign: 'center' }}>
          ...
          <nav style={{ display: 'flex', gap: '30px', justifyContent: 'center' }}>
            ...
            <Link href="/press" style={{ textDecoration: 'none', color: '#000', fontSize: '14px' }}>Press</Link>
            <Link href="/meeds" style={{ textDecoration: 'none', color: '#000', fontSize: '14px', borderBottom: '2px solid #000', paddingBottom: '2px' }}>Meeds</Link>
          </nav>
        </div>
      </header>
      ...
      <main style={{ maxWidth: '1200px', margin: '0 auto', padding: '60px 30px' }}>
        <h2 style={{ fontSize: '28px', fontWeight: '400', marginBottom: '40px', textAlign: 'center' }}>Meeds</h2>
